...
const TREATMENTS = [
{ id:'laser', name:'Laser Hair Removal', page:'/services-hair-removal',
...
{ id:'electrolysis', name:'Electrolysis', page:'/services-hair-removal#electrolysis',
...
{ id:'dermaplaning-hr', name:'Dermaplaning (temporary)', page:'/services-facials',
...
{ id:'hydrafacial', name:'HydraFacial', page:'/services-facials',
...
{ id:'hyperpig', name:'Hyperpigmentation Correction', page:'/services-beautification',
...
{ id:'peels', name:'Chemical Peels', page:'/services-facials',
...
{ id:'microneedling', name:'Microneedling', page:'/services-facials',
...
{ id:'dermaplaning', name:'Dermaplaning', page:'/services-facials',
...
{ id:'acne-facial', name:'Acne Facial', page:'/services-facials',
...
{ id:'anti-aging', name:'Anti-Aging Facial', page:'/services-facials',
  blurb:'Generates new collagen and skin tissue for smoother, firmer, more toned skin.',
...
{ id:'back-facial', name:'Back Facial', page:'/services-facials',
...
{ id:'lash-lift', name:'Keratin Lash Lift', page:'/services-beautification',
...
{ id:'teeth-whitening', name:'Teeth Whitening', page:'/services-beautification',
...
{ id:'lip-blushing', name:'Lip Blushing (PMU)', page:'/services-beautification',
...
{ id:'tooth-gems', name:'Swarovski Tooth Gems', page:'/services-beautification',
...
{ id:'sauna', name:'Infrared Sauna', page:'/services-detox',
...
{ id:'colonics', name:'Colon Hydrotherapy', page:'/services-detox',
...
{ id:'bodywrap', name:'FIT Bodywrap', page:'/services-detox',
...
const CATEGORIES = [
{ id:'hair-removal', label:'Hair Removal Services', page:'/services-hair-removal',
...
{ id:'detox', label:'Detoxification Services', page:'/services-detox',
...
{ id:'facials', label:'Rejuvenating Facials', page:'/services-facials',
...
{ id:'beauty', label:'Precise Beauty Enhancements', page:'/services-beautification',
...
{ id:'assessment', triggers:['assessment','which treatment is right','not sure what i need','not sure which'],
  ...
  link:{label:'Take the Assessment', url:'/precise-self-assessment-v2'} },
{ id:'reviews', triggers:['review','rating','reputation'],
  a:'We\'re rated 5.0 stars from 300+ Google reviews.',
  link:{label:'Read Reviews', url:'/#reviews'} }
];
